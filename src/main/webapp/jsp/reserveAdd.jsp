                ...
                <form class="layui-form" action="${pageContext.request.contextPath}/reserved/addRe" method="post">
                    ...
                    <div class="layui-form-item">
                        <label for="sname" class="layui-form-label">
                            <span class="x-red">*</span>场地</label>
                        <div class="layui-input-inline">
                            <input type="hidden" value="${site.sid}" name="sid" id="ip1">
                            <input type="text" id="sname"  required="" lay-verify="required" autocomplete="off" class="layui-input" value="${site.sname}" readonly></div>
                    </div>
                    <div class="layui-form-item">
