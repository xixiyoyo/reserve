...
<html class="x-admin-sm">
                ...
                <form class="layui-form" action="${pageContext.request.contextPath}/reserved/addRe" method="post">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="username"  required="" lay-verify="required" autocomplete="off" class="layui-input" value="${user.uname}" readonly></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="phoneNum" class="layui-form-label">
                            <span class="x-red">*</span>电话号码</label>
                        <div class="layui-input-inline">
                            <input type="text" id="phoneNum"  required="" lay-verify="required" autocomplete="off" class="layui-input" value="${user.phoneNum}" readonly></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                           <div class="layui-inline">
                            ...
                            <div class="layui-inline">
    <%--                            <label class="layui-form-label">搜索选择场地</label>--%>
    <%--                            <div class="layui-input-inline">--%>
    <%--                                <select name="modules" lay-verify="required" lay-search="" id="se">--%>
    ...
    <%--                            </div>--%>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="datetime-local" id="stime" name="stime" required="" lay-verify="required" autocomplete="off" class="layui-input"><span id="sp1"></span></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="etime" class="layui-form-label">
                            <span class="x-red">*</span>结束时间</label>
                        <div class="layui-input-inline">
                            <input type="datetime-local" id="etime" name="etime" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
                    </div>
...
<%--        </div>--%>
        ...
        <div class="layui-form-item">
            ...
            <button class="layui-btn" lay-filter="add" id="sub">增加</button>
        </div>
            ...
            $(function () {
                ...
                $("#sub").on("click",function () {
                    if($("#sp1").text() == "可选"&&$("#se").val()!=null){
                        ...
                        var etime = now4;
                        var sid = $("#se").val();
                        var data  = {stime:stime,etime:etime,sid:sid};
                        console.log(stime);
                        console.log(etime);
                        $.ajax({
                            url: "/reserved/addRe",
