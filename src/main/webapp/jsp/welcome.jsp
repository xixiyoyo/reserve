...
<!--                </div>-->
                <c:forEach items="${sites}" var="site">
                    <div class="layui-col-sm8 layui-col-md4">
                        <div class="layui-card">
                            <div class="layui-card-header">羽毛球馆

                                <span class="layui-badge layui-bg-cyan layuiadmin-badge">月</span></div>
                            <div class="layui-card-body ">
                                <p><img src="${site.simag}" height="200" width="300"></p>
                                <p>${site.sname}</p>
                                <p><c:if test="${site.sstatus == 0}"><a style="color: green">未使用</a></c:if><c:if test="${site.sstatus == 1}"><a style="color: red">使用中</a></c:if></p>
                                <p><a href="${pageContext.request.contextPath}/site/findAllReBySi?sid=${site.sid}">预约详情</a></p>
                                <p>现在预约人数:${site.num}</p>
                                <p><c:if test="${site.num < 5}">推荐
                                    <i class="layui-inline layui-icon layui-icon-face-smile-b"></i></span>
                                </c:if>
                                    <c:if test="${site.num >= 5}">不推荐
                                        <i class="iconfont">&#xe69c;</i>
                                    </c:if>
                                </p>
                            </div>
